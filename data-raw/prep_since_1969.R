...
# url = "https://seer.cancer.gov/popdata/yr1969_2016.19ages/us.1969_2016.19ages.txt.gz"
# fil_gz = "data-raw/us.1969_2016.19ages.txt.gz"
# fil    = "data-raw/us.1969_2016.19ages.txt"

# Option 2: Use the single year age groups
url = "https://seer.cancer.gov/popdata/yr1969_2016.singleages/us.1969_2016.singleages.txt.gz"
fil_gz = "data-raw/us.1969_2016.singleages.txt.gz"
fil    = "data-raw/us.1969_2016.singleages.txt"
...
raw %>%
    ...
    group_by(state_fips, usps, county_fips, year, race) %>%
    summarise(pop = pop %>% sum()) %>%
    spread(race, pop) %>%
    print() -> pop_by_race
...
pop %>%
    ...
    print() -> pop_since_1969

devtools::use_data(pop_since_1969, overwrite = TRUE)
